...
它記錄了巴逆逆（8zz）在 Facebook 公開發文的買賣操作，並以**反向信號**呈現在 K 線圖上。核心哲學：**她停損賣出 → 指標偏多 ▲；她買進抄底 → 指標偏空 ▼。**

收錄 **63 筆**真實 FB 貼文操作，時間橫跨 2025/12 ~ 2026/04。

---

## 回測截圖（0050 · 1小時線）

![8zz 反指標回測 - 元大台灣50 1小時](assets/backtest-0050.png)

> **關於勝率的說明**
>
> 上圖在 0050（元大台灣50）上的固定8棒勝率最高約 **60%**。這不是指標不準，而是因為 8zz 喊的大多是**個別股票**（鈦昇、旺宏、白銀、記憶體股等），拿 ETF 來對照本來就會被稀釋。
>
> **用在她實際操作的個股上，勝率更高。**
>
